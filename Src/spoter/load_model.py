...
def get_slrt_model(args):
    ...
    ############################### MODELOS New Model Generative+Classification with ResiDual Connections ##################################################
        ...
        args.script_run_model = f""" SPOTER5(num_classes={args.num_classes},
                            ...
                            dim_feedforward_encoder={args.dim_feedforward_encoder},
                            dim_feedforward_decoder={args.dim_feedforward_decoder},dropout={args.dropout})"""
    elif args.model_name == "generative_class_residual_piramidal":
        print("USING SPOTER  New Model Generative+Classification with ResiDual Connections Piramidal")
        slrt_model = SPOTER6(num_classes=args.num_classes,
                            hidden_dim=args.hidden_dim, num_heads=args.num_heads, 
                            num_layers_1=args.num_layers_1, num_layers_2=args.num_layers_2, 
                            dim_feedforward_encoder=args.dim_feedforward_encoder,
                            dim_feedforward_decoder=args.dim_feedforward_decoder,dropout=args.dropout
        ...
        args.freeze_decoder_layers = None
        args.has_mlp = None
        args.script_run_model = f""" SPOTER6(num_classes={args.num_classes},
                            hidden_dim={args.hidden_dim}, num_heads={args.num_heads}, 
                            num_layers_1={args.num_layers_1}, num_layers_2={args.num_layers_2}, 
                            dim_feedforward_encoder={args.dim_feedforward_encoder},
                            dim_feedforward_decoder={args.dim_feedforward_decoder},dropout={args.dropout})"""

    elif args.model_name == "generative_class_residual_ae":
        print("USING SPOTER  New Model Generative+Classification with ResiDual Connections Autoencoder")
        slrt_model = SPOTER7(num_classes=args.num_classes,
                            hidden_dim=args.hidden_dim, num_heads=args.num_heads, 
                            num_layers_1=args.num_layers_1, num_layers_2=args.num_layers_2, 
                            dim_feedforward_encoder=args.dim_feedforward_encoder,
                            dim_feedforward_decoder=args.dim_feedforward_decoder,dropout=args.dropout
